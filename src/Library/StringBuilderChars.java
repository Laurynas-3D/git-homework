...
/**
 This program:
 - Demonstrates StringBuilder methods charAt, setCharAt, getChars and reverse
...
public class StringBuilderChars {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("The characters in array are: ");
        ...
        buffer.reverse();
        System.out.printf("%n%nbuffer in reverse = %s%n", buffer.toString());
